% ==================================================
% เอกสารชี้แจงเกณฑ์การวัดและประเมินผลรายวิชาคณิตศาสตร์ ม.ปลาย (แก้ไข Header ค้าง)
% ==================================================

\clearpage
\thispagestyle{empty} % <--- ไล่เลขหน้า และล้างหัวกระดาษ (คำว่าสารบัญ) เฉพาะหน้านี้ออก!
...
\begin{enumerate}[label=\arabic*)., leftmargin=2em, itemsep=0.8em]
	\item \textbf{คะแนนสอบวัดผลเชิงวิชาการ (รวม $30$ คะแนน)}
	\begin{itemize}
		\item \textbf{การสอบกลางภาค ($15$ คะแนน) :} จัดสอบนอกตารางหรือตามตารางของโรงเรียน เพื่อวัดความรู้รวบยอดครึ่งเทอมแรก
		\item \textbf{การสอบปลายภาค ($15$ คะแนน) :} จัดสอบตามตารางของโรงเรียน เพื่อวัดทักษะและการประยุกต์ใช้ในครึ่งเทอมหลัง
	\end{itemize}
	
	\vspace{0.1cm}
	\item \textbf{คะแนนจิตพิสัยและความประพฤติ ($10$ คะแนน)}
	\begin{itemize}
		\item ประเมินจากการเข้าเรียนตรงเวลา ความพร้อมของอุปกรณ์การเรียน การแต่งกายถูกระเบียบ และการปฏิบัติตามข้อตกลงในชั้นเรียน (เช็กชื่อและพฤติกรรมทุกคาบเรียน)
	\end{itemize}
	
	\vspace{0.1cm}
	\item \textbf{คะแนนแบบฝึกหัดและสมุด ($25$ คะแนน)}
	\begin{itemize}
		\item \textbf{รูปแบบการจัดเก็บ :} เน้นการฝึกฝนอย่างสม่ำเสมอ โดยมอบหมายแบบฝึกหัดท้ายคาบ
		\item \textbf{เกณฑ์การตรวจ :} ตรวจสอบความสม่ำเสมอ ความตั้งใจในการเขียนแสดงวิธีทำ และการส่งงานตรงเวลา 
	\end{itemize}
	
	\vspace{0.1cm}
	\item \textbf{คะแนนทดสอบประจำหน่วย / Quiz ($10$ คะแนน)}
	\begin{itemize}
		\item จัดสอบเป็นแบบทดสอบย่อย (Quiz) หลังจากเรียนจบหัวข้อสำคัญ 
	\end{itemize}
	
	\vspace{0.1cm}
	\item \textbf{คะแนนชิ้นงานกลุ่ม ($15$ คะแนน)}
	\begin{itemize}
		\item \textbf{รูปแบบกิจกรรม :} แบ่งกลุ่มนักเรียนกลุ่มละ $3$--$4$ คน มอบหมายโจทย์หลังเรียนกลุ่มละ $1$ ข้อ ส่งตามเวลาที่กำหนด
	\end{itemize}
	
	\vspace{0.1cm}
	\item \textbf{คะแนนกิจกรรมในชั้นเรียนและการนำเสนอ ($10$ คะแนน)}
	\begin{itemize}
		\item \textbf{รูปแบบกิจกรรม :} ต่อยอดจากกิจกรรมกลุ่ม (ข้อ $5$) โดยจะทำการสุ่มตัวแทนนักเรียน $1$ คนจากแต่ละกลุ่ม ออกมาอธิบายแนวคิดและแสดงวิธีทำของโจทย์ที่กลุ่มตนเองได้รับหน้าชั้นเรียน 
	\end{itemize}
\end{enumerate}
