...
$$
\begin{aligned}
	\dfrac{\sin \left( x \right)}{1 + \cos \left( x \right)} &= \dfrac{\sin \left( 2\left(\dfrac{x}{2}\right) \right)}{1 + \cos \left( 2\left(\dfrac{x}{2}\right) \right)} \\
	&= \dfrac{2 \sin \left( \dfrac{x}{2} \right) \cos \left( \dfrac{x}{2} \right)}{1 + 2 \cos^{2} \left( \dfrac{x}{2} \right) - 1} \\
...
\end{examplebox}
\proof โดยใช้สูตรแปลงผลบวกผลต่างเป็นผลคูณจะได้
$$
\begin{aligned}
