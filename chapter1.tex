...
เมื่อทราบค่าของ $\sin(\alpha)$, $\cos(\alpha)$ หรือ $\tan(\alpha)$ จะสามารถหาค่าของฟังก์ชันตรีโกณมิติของจำนวนซึ่งเป็นสองเท่าของ $\alpha$ ได้ โดยอาศัยค่าของ $\sin(\alpha+\beta)$, $\cos(\alpha+\beta)$ และ $\tan(\alpha+\beta)$ ตามลำดับ เช่น หาค่าของ $\sin(2\alpha)$ ได้ดังนี้
\\
เนื่องจาก
$$
\begin{aligned}
...
นอกจากนี้ยังสามารถหาค่าของ $\cos(2\alpha)$ จาก $\cos(\alpha+\beta)$ ได้ดังนี้
$$
\begin{aligned}
