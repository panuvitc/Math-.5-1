...
\remark
\\[0.3em]
$\cos^2\theta$ \quad หมายถึง $(\cos\theta)(\cos\theta)$ 
\\
$\cos\theta^2$ \quad หมายถึง คอสของจำนวนจริง $\theta^2$
...
\begin{figure}[H] 
	...
	\caption{พิกัดของจุดปลายส่วนโค้งบนวงกลมหนึ่งหน่วยในจตุภาคที่ 2 เทียบกับภาพสะท้อนในจตุภาคที่ 1} 
	\label{Figure8} 
\end{figure}
...
\begin{figure}[H] 
	...
	\caption{พิกัดของจุดปลายส่วนโค้งบนวงกลมหนึ่งหน่วยในจตุภาคที่ 3 เทียบกับภาพสะท้อนในจตุภาคที่ 1} 
	\label{Figure9} 
\end{figure}
...
\begin{figure}[H] 
	...
	\caption{พิกัดของจุดปลายส่วนโค้งบนวงกลมหนึ่งหน่วยในจตุภาคที่ 4 เทียบกับภาพสะท้อนในจตุภาคที่ 1} 
	\label{Figure10} 
\end{figure}
...
\begin{figure}[H] 
	\centering 
	\includegraphics[scale=0.33]{12} 
	\caption{การวัดขนาดของมุมในทิศทางทวนเข็มนาฬิกาและตามเข็มนาฬิกา} 
	\label{Figure12} 
\end{figure}
...
\\
เรียกส่วนของเส้นตรง $AQ$ และ $AQ^{\prime}$ ว่า \textbf{ด้านสิ้นสุด (terminal side)} ของมุม
...
\begin{figure}[H] 
	...
	\caption{นิยามของมุมขนาด 1 เรเดียนบนวงกลม} 
	\label{Figure13} 
\end{figure}

\vspace{0.5em}
\noindent \textbf{บทนิยาม:} มุมที่จุดศูนย์กลางของวงกลมซึ่งรองรับด้วยส่วนโค้งของวงกลมที่ยาวเท่ากับรัศมีของวงกลมนั้น เป็นมุมที่มีขนาด 1 เรเดียน
...
\begin{figure}[H] 
	...
	\caption{การนิยามอัตราส่วนตรีโกณมิติด้วยรูปสามเหลี่ยมคล้ายบนวงกลมหนึ่งหน่วย} 
	\label{Figure15} 
\end{figure}
