...
% ---- math operators ----
% ตัวนี้มีในระบบอยู่แล้ว ไม่ต้องประกาศซ้ำครับ
		...
		\begin{tabular}{!{\color{coverblue}\vrule width 5pt} p{\dimexpr\textwidth-25pt}}
			...
			\colorbox{coverblue!10}{
				\begin{minipage}[t]{\dimexpr\textwidth-25pt}
					...
					{\Huge\bfseries\color{covergray} รายวิชาเพิ่มเติม ม.5 เล่ม 1}\\[1.0em]
					{\Large\bfseries\color{covergray} หัวข้อ : ฟังก์ชันตรีโกณมิติ}
...
เอกสารประกอบการสอนคณิตศาสตร์ รายวิชาเพิ่มเติม รหัสวิชา ค32201 ชั้นมัธยมศึกษาปีที่ 5 เรื่อง “ฟังก์ชันตรีโกณมิติ” ฉบับนี้ จัดทำขึ้นเพื่อใช้เป็นสื่อประกอบการจัดกิจกรรมการเรียนรู้ในชั้นเรียน โดยมุ่งส่งเสริมให้นักเรียนได้พัฒนาความรู้ ความเข้าใจ และทักษะการคิดทางคณิตศาสตร์ผ่านการศึกษาเนื้อหา การทำกิจกรรม และการแก้ปัญหาอย่างเป็นระบบ

เอกสารฉบับนี้จัดทำและออกแบบด้วยโปรแกรม \LaTeX{} โดยอ้างอิงโครงสร้างเนื้อหาจากหนังสือเรียนของ สสวท. และปรับรูปแบบการนำเสนอให้เหมาะสมกับการใช้งานของครูผู้สอน พร้อมเว้นพื้นที่สำหรับการอธิบายเนื้อหา การแสดงวิธีทำตัวอย่าง และการขยายรายละเอียดเพิ่มเติมระหว่างการสอน
...
\vspace{1.5cm}
\begin{flushright}
	\begin{tabular}{c} % แก้ไขจาก ; เป็น { } เรียบร้อยครับ
		ภาณุวิชญ์ เชื้อพล \\
		ผู้จัดทำ
	\end{tabular}
\end{flushright}
