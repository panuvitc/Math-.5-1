%\documentclass[a4paper,oneside,12pt,draft]{book} % ไม่ประมวลผลรูปภาพ
...
\begin{document}
% ------------------------------------------
% หน้าปก (Title Page) - อัปเดตข้อมูลเป็น ม.5 เล่ม 1 (พิมพ์ครั้งที่ 4)
% ------------------------------------------
\begin{titlepage}
	\centering
	% ===== กำหนดสีภายในหน้าปก =====
			...
			\colorbox{coverblue!10}{
				\begin{minipage}[t]{\dimexpr\textwidth-25pt}
					...
					{\Large\bfseries\color{covergray}
						เอกสารประกอบการสอนคณิตศาสตร์}\\[0.8em]
					
					{\Huge\bfseries\color{covergray}
						รายวิชาเพิ่มเติม ม.5 เล่ม 1}\\[1.0em]
	...
	\begin{minipage}{0.8\textwidth}
		...
		{\large โรงเรียนสาธิตมหาวิทยาลัยขอนแก่น}\\[0.1cm]
		{\large วิทยาเขตหนองคาย}
	\end{minipage}
	
	\vfill
	
	{\small ปีการศึกษา 2569}
...
เอกสารประกอบการสอนคณิตศาสตร์ รายวิชาเพิ่มเติม รหัสวิชา ค32201 ชั้นมัธยมศึกษาปีที่ 5 เรื่อง \textquotedblleft ฟังก์ชันตรีโกณมิติ\textquotedblright\ ฉบับนี้ จัดทำขึ้นเพื่อใช้เป็นสื่อประกอบการจัดกิจกรรมการเรียนรู้ในชั้นเรียน โดยมีวัตถุประสงค์เพื่อส่งเสริมความรู้ ความเข้าใจ และทักษะกระบวนการทางคณิตศาสตร์ของนักเรียน ตลอดจนสนับสนุนการจัดการเรียนการสอนให้เป็นไปอย่างมีประสิทธิภาพ

เอกสารฉบับนี้จัดทำและออกแบบด้วยโปรแกรม \LaTeX{} โดยยึดเนื้อหาหลักจากหนังสือเรียนรายวิชาเพิ่มเติมคณิตศาสตร์ ชั้นมัธยมศึกษาปีที่ 5 ของสถาบันส่งเสริมการสอนวิทยาศาสตร์และเทคโนโลยี (สสวท.) และได้ปรับรูปแบบการนำเสนอให้เหมาะสมกับบริบทการจัดการเรียนการสอนของผู้จัดทำ ทั้งในด้านการจัดลำดับเนื้อหา การเว้นพื้นที่สำหรับแสดงวิธีทำ การบันทึกแนวคิดสำคัญ และการทำกิจกรรมร่วมกันในชั้นเรียน

ผู้จัดทำขอขอบพระคุณสถาบันส่งเสริมการสอนวิทยาศาสตร์และเทคโนโลยี (สสวท.) ซึ่งเป็นแหล่งที่มาหลักของเนื้อหา ตัวอย่าง และกิจกรรมการเรียนรู้ที่ใช้ในการเรียบเรียงเอกสารฉบับนี้ และหวังเป็นอย่างยิ่งว่าเอกสารประกอบการสอนฉบับนี้จะเป็นประโยชน์ต่อการเรียนรู้ของนักเรียน รวมทั้งเป็นส่วนหนึ่งในการส่งเสริมความเข้าใจทางคณิตศาสตร์และการนำความรู้ไปประยุกต์ใช้ได้อย่างเหมาะสม
...
\begin{thebibliography}{99}
	...
	\textit{หนังสือเรียนรายวิชาเพิ่มเติมคณิตศาสตร์ ชั้นมัธยมศึกษาปีที่ 5 เล่ม 1} (พิมพ์ครั้งที่ 4).
